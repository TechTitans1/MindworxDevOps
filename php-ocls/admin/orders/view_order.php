            ...
            <table class="table-striped table table-bordered" id="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">R <?php echo number_format($row['price']) ?></td>
                        <td class="text-right">R <?php echo number_format($row['price'] * $row['quantity']) ?></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <th class="text-right">R <?php echo number_format($amount) ?></th>
                    </tr>
                </tfoot>
            </table>
        </div>
